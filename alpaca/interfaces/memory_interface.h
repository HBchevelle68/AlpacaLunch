...
extern ALPACA_STATUS  AlpacaBuffer_append(ALLU_Buffer_t **alluBuffer, uint8_t *data, size_t size);
extern ALLU_Buffer_t* AlpacaBuffer_resize(ALLU_Buffer_t **alluBuffer, size_t memNeeded);
extern ALPACA_STATUS  AlpacaBuffer_ensureRoom(ALLU_Buffer_t **alluBuffer, size_t memNeeded);
