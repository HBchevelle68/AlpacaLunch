...
void steque_init(steque_t* thisSteque);

/* Return 1 if empty, 0 otherwise */
int steque_isempty(steque_t* thisSteque);

/* Returns the number of elements in the steque */
int steque_size(steque_t* thisSteque);

/* Adds an element to the "back" of the steque */
void steque_enqueue(steque_t* thisSteque, steque_item item);

/* Adds an element to the "front" of the steque */
void steque_push(steque_t* thisSteque, steque_item item);

/* Removes an element to the "front" of the steque */
steque_item steque_pop(steque_t* thisSteque);

/* Removes the element on the "front" to the "back" of the steque */
void steque_cycle(steque_t* thisSteque);

/* Returns the element at the "front" of the steque without removing it*/
steque_item steque_front(steque_t* thisSteque);

/* Empties the steque and performs any necessary memory cleanup */
void steque_destroy(steque_t* thisSteque);
